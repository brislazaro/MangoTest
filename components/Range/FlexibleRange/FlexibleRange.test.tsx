...
describe("Given a FlexibleRange component min input", () => {
...
describe("Given a FlexibleRange component max input", () => {
  describe("When initial value is 1 and max is 100", () => {
    beforeEach(() => {
      renderComponentFactory(<FlexibleRange min={1} max={100} />);
    });
